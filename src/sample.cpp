...
Sample::Sample(const string &tm, const string &lbl, const string &def, const string &qual, double res, const string &un, int north, int east) : time(tm), label(lbl), definition(def), qualifier(qual), result(res), unit(un), northing(north), easting(east)
{
  ostringstream error;
